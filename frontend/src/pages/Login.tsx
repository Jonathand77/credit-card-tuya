...
export default function Login() {
  ...
  const submit = async (e: any) => {
    e.preventDefault()
    if (!username.trim()) { showToast('El usuario es requerido', 'warning'); return }
    if (!email.trim()) { showToast('El email es requerido', 'warning'); return }
    if (!password.trim()) { showToast('La contraseña es requerida', 'warning'); return }
